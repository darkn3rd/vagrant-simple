...
_config = os.environ.get('VAGRANT_CONFIG') or '{}/global.json'.format(_script_home)
...
def get_ssh_config():
    ...
    # read global json file into python dictionary
    hosts = json.loads(open(_config).read())['hosts']
...
def get_a_ssh_config(box_name):
    ansible_config = {}
    ip = json.loads(open(_config).read())['hosts'][box_name]
