...
_config = os.environ.get('VAGRANT_CONFIG') or '{}/global.yaml'.format(_script_home)
...
def get_ssh_config():
    ...
    # read global yaml file into python dictionary
    hosts = yaml.load(open(_config).read())['hosts']
...
def get_a_ssh_config(box_name):
    ...
    # read global yaml file into python dictionary and retreive ip
    ip = yaml.load(open(_config).read())['hosts'][box_name]
